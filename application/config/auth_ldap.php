...
$config['ldap_uris'] = array('ldap://taj.local:389');
$config['use_tls'] = false;
$config['basedn'] = 'OU=STAFF,DC=Taj,DC=local';
$config['use_ad'] = true;
$config['ad_domain'] = 'taj.local';
$config['login_attribute'] = 'uid';
$config['proxy_user'] = 'taj281@tajbank.com';
$config['proxy_pass'] = 'Ibot5alobija!';
